package com.newcore.wezy.ui.utils
...
object ViewHelpers {
    ...
    private const val TAG = "ViewHelpers"
    fun setAppLocale(localeCode: String? = null, resources: Resources, reBuildActivity: Activity) {
//        updateResources(reBuildActivity, localeCode ?: Locale.getDefault().language)
        val dm = resources.displayMetrics
        val config = resources.configuration

        Log.e(TAG, ("setAppLocale: $localeCode"))
        config.setLocale(
            Locale(
